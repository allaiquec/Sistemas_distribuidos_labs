...
public class SOAPImplServiceLocator extends org.apache.axis.client.Service implements com.sdlab.ws.app.SOAPImplService {
    ...
    public com.sdlab.ws.app.SOAPI getSOAPImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.sdlab.ws.app.SOAPImplPortBindingStub _stub = new com.sdlab.ws.app.SOAPImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.sdlab.ws.app.SOAPI.class.isAssignableFrom(serviceEndpointInterface)) {
                com.sdlab.ws.app.SOAPImplPortBindingStub _stub = new com.sdlab.ws.app.SOAPImplPortBindingStub(new java.net.URL(SOAPImplPort_address), this);
                _stub.setPortName(getSOAPImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://app.ws.sdlab.com/", "SOAPImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://app.ws.sdlab.com/", "SOAPImplPort"));
        }
